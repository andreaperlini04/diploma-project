"""Test dei template di description. Funzioni pure: nessuna app, nessun
database. I testi attesi sono quelli del plugin: le righe già in timeline li
usano, riformularli spezzerebbe la stessa description a metà dataset.
"""

"""Test di SessionService in isolamento: niente Flask, niente HTTP. Il
repository è quello vero su file temporaneo, perché la parte interessante è
l'allineamento fra stato in memoria e stato su disco.
"""
...
def test_ensure_registered_does_not_activate_the_session(service):
    """Recupera i dati di un client che ha perso la POST di session_start, ma
    non la rende corrente: gli eventi Moodle in arrivo non devono finire su una
    sessione mai annunciata."""

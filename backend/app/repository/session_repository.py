...
class SessionRepository:
    ...
    def init_schema(self) -> None:
        with self._lock, self._connect() as conn:
            ...
            # Migrazione per i database creati prima di questa colonna. SQLite
    ...
    def save_open(self, session: Session) -> bool:
        ...
        INSERT OR IGNORE: un session_start rispedito, o i campioni tardivi di
        una sessione già chiusa, non devono azzerare stopped_at/row_count.
    ...
    def attach_user(self, session_id: str, user_id: int) -> None:
        ...
        COALESCE e non UPDATE secco: una sessione è di un solo studente, un
        secondo user_id è un'anomalia (due account sulla stessa macchina) e non
        deve riscrivere l'attribuzione già data alle righe della timeline.
        """
        with self._lock, self._connect() as conn:
            conn.execute(

...
def create_ingest_routes(timeline_service: TimelineService) -> Blueprint:
    ...
    nell'envelope comune; la discriminazione è sui campi source / event_type,
    non sull'URL. Lo stream è un log append-only: session_start, session_end e
    clock_skew_measured sono eventi come gli altri e la sessione è una
    proiezione sullo stream, non una risorsa parallela.
    """
    ...
    def ingest_events():
        ...
        # l'oggetto singolo è accettato lo stesso, costa una riga.
